...
namespace TP2.Controllers
{
    public class DireccionController : Controller
    {
        ...
        public DireccionController(MvcHeladeriaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Direccion != null ? 
                          ...
                          Problem("Entity set 'MvcHeladeriaContext.Direccion'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MvcHeladeriaContext.Direccion'  is null.");
            }
            var direccion = await _context.Direccion.FindAsync(id);
            if (direccion != null)
            {
