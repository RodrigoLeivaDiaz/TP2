...
namespace TP2.Migrations
{
    ...
    [Migration("20230430002453_ManytoMany")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HeladeriaHelado", b =>
                {
                    b.Property<int>("HeladeriasId")
                        .HasColumnType("INTEGER");

                    b.Property<int>("HeladosId")
                        .HasColumnType("INTEGER");

                    b.HasKey("HeladeriasId", "HeladosId");

                    b.HasIndex("HeladosId");

                    b.ToTable("HeladeriaHelado");
                });
            ...
            modelBuilder.Entity("HeladeriaHelado", b =>
                {
                    b.HasOne("TP2.Models.Heladeria", null)
                        .WithMany()
                        .HasForeignKey("HeladeriasId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TP2.Models.Helado", null)
                        .WithMany()
